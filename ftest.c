/*
 *   ftest.c -- Raspberry Pi Model F keyboard test program.
 *   Used to determine pf2i module load parameters.
 *
...
//To compile this program: gcc ftest.c -o ftest
//Make sure /boot/config.txt includes core_freq=250
//Make sure the f2pi module is not loaded, then run ftest as root.
...
void main(int argc, char **argv) 
{
    ...
    baud = 2500;
    printf("\nPress and hold the F6 key on the Model F keyboard.\n");
    fflush(NULL);
